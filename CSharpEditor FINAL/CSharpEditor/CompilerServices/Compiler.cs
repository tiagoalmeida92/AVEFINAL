...
namespace CSharpEditor.CompilerServices
{
    public class Compiler
    {
        ...
        public static bool CompileCode(CodeDomProvider codeProvider, string sourceCode, string sourceFile,
                                       string exeFile, string assemblyName, string[] resourceFiles,
        ...
        public static void Main()
        {
            ...
            var cSharpCodeProvider1 = new CSharpCodeProvider();
            if (CompileCode(cSharpCodeProvider1, cSharpSourceCode1, null,
            ...
            /// Another Example
            ////////////////////////////////////////////////////////////////////////////////////////////////////
            var cSharpCodeProvider2 = new CSharpCodeProvider();
            ...
            if (CompileCode(cSharpCodeProvider2, cSharpSourceCode2, null, null,
                            "D:\\Temp\\C-Sharp-test2.dll", null, null, out errors, out results))
            {
                ...
                Console.WriteLine("Value of Bar.MyFoo.MyProperty: " + PropertyValue);
            }
            else
                Console.WriteLine("Error occurred during compilation : \r\n" + errors);
